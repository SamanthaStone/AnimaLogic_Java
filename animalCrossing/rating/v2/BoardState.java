...
public class BoardState {
	...
	private static double dsratio = 0;
	static double averageLengthOfDeadEnd = 0;
	static LinkedList<Integer> deadEndArray = new LinkedList<>();
	public static int treeSols = 0;
	public static int treeFails = 0;
	public boolean treeTrue = false;
	...
	public static double getdsratio() {
		return dsratio = (double) deadEnds / solutions;
	}
	...
	public static void printStatistics() {
		...
		getdsratio();
		System.out.println("Dead End to Solution Ratio: " + dsratio);
		System.out.println("Dead End Trees: " + treeFails);
		System.out.println("Solution Trees: " + treeSols);
		System.out.println("Dead End to Solution Trees Ratio: " + (double) treeFails / treeSols);
