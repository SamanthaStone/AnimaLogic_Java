...
import animalCrossing.rating.v1.Animal.Color;
import animalCrossing.rating.v1.Animal.Species;
...
public class Statistics {
	...
	public static void main(String[] args) {
		...
		// createAndWrite(25); // puts down ~20
	...
	private static void printBoardStats(ArrayList<ArrayList<Animal>> board) {
	...
	private static void createAndWrite(int numberToWrite) {
		try {
			FileOutputStream fos = new FileOutputStream("testing");
	...
	private static ArrayList<ArrayList<ArrayList<Animal>>> readBoards(int numberToRead) {
		ArrayList<ArrayList<ArrayList<Animal>>> boards = new ArrayList<>();
		int i = 0;
		try {
			FileInputStream fos = new FileInputStream("boards");
